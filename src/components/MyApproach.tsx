...
const Card = ({
  ...
  return (
    <div
      ...
      className="border h-[35rem] rounded-3xl border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative"
      style={{
        //   add these two
    ...
    >
      <Icon className="absolute h-6 w-6 -top-3 -left-3 dark:text-white text-black opacity-50" />
      <Icon className="absolute h-6 w-6 -bottom-3 -left-3 dark:text-white text-black opacity-50" />
      <Icon className="absolute h-6 w-6 -top-3 -right-3 dark:text-white text-black opacity-50" />
      <Icon className="absolute h-6 w-6 -bottom-3 -right-3 dark:text-white text-black opacity-50" />
